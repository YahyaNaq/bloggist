...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
		<form action="/dashboard/edit-a-blog" method="POST" enctype="multipart/form-data">
			...
			<div class="space-y-12">
				<div class="border-b border-gray-900/10 pb-12">
					<div class="mt-3 col-span-full">
						...
						<?php if (! ($errors['image'] ?? '')): ?>
						<div class="mt-3">
							<label for="preview" class="block text-sm font-medium leading-6 text-gray-900">Preview</label>
							<div class="mt-2">
								<img id="preview" src="<?= $img_path ?? '' ?>" class="rounded h-80" alt="Preview image">
							</div>
						</div>
						<?php endif; ?>
