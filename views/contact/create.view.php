...
<main>
    ...
    <div class="w-full max-w-md space-y-8">
        <div>
            ...
            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Want to get in touch?</h2>
            <p class="mt-2 text-center text-sm text-gray-600">Fill out the form below to send me a message and we will get back to you as soon as possible!</p>
        </div>
        <form class="mt-8" action="/contact" method="POST">
